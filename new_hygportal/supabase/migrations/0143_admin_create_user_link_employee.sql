-- Allow admin to optionally link an employee profile when creating a user.
...
grant execute on function public.admin_create_unlinked_user(text, text, text, text, uuid) to authenticated;
