-- Keep explicitly selected Store Manager routes store-specific.
-- Higher selected roles can be cross-store/cross-department, but Level 2
-- approvers still need to match the requester's store.
