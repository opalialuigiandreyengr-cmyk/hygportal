alter table public.time_request_details
  drop constraint if exists time_request_details_total_hours_check;

alter table public.time_request_details
  add constraint time_request_details_total_hours_check check (total_hours >= 0);
